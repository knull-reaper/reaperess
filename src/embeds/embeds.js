...
const invite = 'https://discord.com/api/oauth2/authorize?client_id=939037345540354058&permissions=139623489856&scope=bot%20applications.commands';
const github = 'https://knull-reaper.github.io/port/';
...
module.exports = {
    ...
    Embed_invite: function () {
        const Embed_invite = new Discord.EmbedBuilder()
            .setColor(color)
            .setTitle(`${bot_name}`)
            .setURL(invite)
            .setDescription(`**Click My Name Above!😊**`)
        return Embed_invite;
    },
}